...
RETURNING id, user_id, name, watched_date, poster_url, diary, description, location_watched, release_date
`
...
SELECT id, user_id, name, watched_date, poster_url, diary, description, location_watched, release_date FROM movies 
where user_id = ?1
